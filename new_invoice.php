      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <label class="font-weight-bold" for="customers_EMAIL ID_number">EMAIL ID :</label>
              <input id="customers_EMAIL ID_" type="number" class="form-control" name="customers_contact_number" placeholder="Contact Number" disabled>
